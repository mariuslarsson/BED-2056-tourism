...
plot(rnorm(111), pch=135, col="pink")
```

```{r}
#keep adding to branch
#
plot(rnorm(10), col="red", pch=20)
```

```{r}
#The final branch test

plot(rnorm(100), type='l', lwd=2, col="red")
```

```{r}
#combination test branch/master
1336+1
```
